...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
		...
		else if (ev.type == ALLEGRO_EVENT_TIMER)
		{
			...
			if ((!(((kolider_x + 41 > 0) && (kolider_x + 41 <= 795)) || ((kolider_x + 41 > 850) && (kolider_x + 41 < 795 + 850)) || (skok==true))))
			{
				pos_y += 20;
			}

			if ((((kolider_x > grunt1_x + 1000 + kolider_w1) && (kolider_x < grunt1_x + 1000 + kolider_w1 + 220)) || ((kolider_x > grunt1_x + 1300 + kolider_w2) && (kolider_x <grunt1_x + 1300 + kolider_w2 + 220))))
			{
				ilosc_zyc -= 1;
			}
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
		...
		if (przerys && al_is_event_queue_empty(event_queue))//unika ghostow
		{
			...
			//al_draw_textf(font18, al_map_rgb(50, 0, 255), 350, 50, ALLEGRO_ALIGN_LEFT, "%i",  grunt1_x + 1000 + kolider_w1);
			//al_draw_textf(font18, al_map_rgb(200, 0, 255), 150, 50, ALLEGRO_ALIGN_LEFT, "%i", ilosc_zyc);
